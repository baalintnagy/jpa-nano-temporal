...
**GitHub**: [Create a private security advisory](https://github.com/baalintnagy/jpa-nano-temporal/security/advisories/new)
...
For questions about this security policy, [create an issue](https://github.com/baalintnagy/jpa-nano-temporal/issues).
