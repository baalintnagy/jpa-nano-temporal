...
1. **Fork the repository**
   ```bash
   git clone https://github.com/YOUR_USERNAME/jpa-nano-temporal.git
...
- Search [existing issues](https://github.com/baalintnagy/jpa-nano-temporal/issues)
- Start a [discussion](https://github.com/baalintnagy/jpa-nano-temporal/discussions)
