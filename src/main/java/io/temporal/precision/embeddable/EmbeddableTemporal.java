...
public class EmbeddableTemporal implements Comparable<EmbeddableTemporal>, Serializable {
    ...
    /**
     * Returns true if this temporal value is positive (greater than zero).
     * 
    ...
    /**
     * Returns true if this temporal value is negative (less than zero).
     * 
    ...
    /**
     * Adds another EmbeddableTemporal to this one and returns the result as a new instance.
     * 
     * @param other the temporal value to add
     * @return a new EmbeddableTemporal representing the sum
     * @throws NullPointerException if other is null
     */
    public EmbeddableTemporal add(EmbeddableTemporal other) {
        Objects.requireNonNull(other, "Other temporal value cannot be null");
        return new EmbeddableTemporal(this.seconds + other.seconds, this.nanos + other.nanos);
    }

    /**
     * Subtracts another EmbeddableTemporal from this one and returns the result as a new instance.
     * 
     * @param other the temporal value to subtract
     * @return a new EmbeddableTemporal representing the difference
     * @throws NullPointerException if other is null
     */
    public EmbeddableTemporal subtract(EmbeddableTemporal other) {
        Objects.requireNonNull(other, "Other temporal value cannot be null");
        return new EmbeddableTemporal(this.seconds - other.seconds, this.nanos - other.nanos);
    }

    /**
     * Returns the absolute value of this temporal value as a new instance.
     * 
     * @return a new EmbeddableTemporal representing the absolute value
     */
    public EmbeddableTemporal abs() {
        if (isNegative()) {
            return new EmbeddableTemporal(-seconds, -nanos);
        }
        return new EmbeddableTemporal(seconds, nanos);
    }
}
